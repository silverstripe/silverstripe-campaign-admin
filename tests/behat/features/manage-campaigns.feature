...
Feature: Manage campaigns
  ...
  Scenario: I can create a campaign
    ...
    And I fill in "Name" with "newcampaign"
    And I fill in "Description" with "awesome campaign"
    And I press the "Create" button
    And I should see "Saved." in the message box
    When I press the "Campaigns" button
    Then I should see the campaign "newcampaign"
    When I view the campaign "newcampaign"
    Then the "Publish campaign" button should be disabled
  Scenario: I can edit campaign
    ...
    Then the "Description" field should contain "this is a test"
